        ...
        <!--for name-->
            ...
            <div class="absolute -top-16 left-1/2 transform -translate-x-1/2">
                <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-white">
                    <img src="images/profile_wm.png" alt="my photo" class="w-full h-full object-cover" />
                </div>
            </div>

            <!-- my name -->
            <h1 class="text-2xl text-center font-semibold">Ysabella Kristine B. Romero</h1>

            <h2 class="text-center text-l italic mt-4">Computer Science student</h2>
            <!-- divider / hr -->
            <hr class="my-6 border-gray-800 w-3/4 mx-auto">
            <!-- description -->
            <p class="text-left text-gray-700 mt-2 mx-6">
                Hi! I am a Fourth year Computer Science student with hands-on experience with several programming languages such as 
                <b>Python, JavaScript, HTML, and PHP. </b> 
                <br><br>I usually play games in my downtime like <b> Sword of Justice, Legend of the Phoenix, MLBB, and Roblox </b> but I am slowly learning game development as another past time.<br> <br>
                My hobbies are usually reading online stories, writing, and drawing digitally which I have linked in my portfolio. <br> <br>
            </p>
            <hr class="my-6 border-gray-800 w-3/4 mx-auto">
