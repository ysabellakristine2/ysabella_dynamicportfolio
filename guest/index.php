...
// for secret profile, had to use DOM content loader for this because it broke lol
document.addEventListener("DOMContentLoaded", () => {
    let secretClicks = 0;

    const secretProfile = document.getElementById("secret-profile");
    if (!secretProfile)

    secretProfile.addEventListener("click", function () {
        secretClicks++;
        if (secretClicks < 5) return;

        if (secretClicks === 5) {
            secretProfile.src = "images/ser ivan.jpg";
